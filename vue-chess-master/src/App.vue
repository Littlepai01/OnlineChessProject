<template>
    <div>
        ...
        <md-navbar title="OnlineChess" hamburger mode="hide-on-med-and-down" left nav-class="blue darken-4">
                    ...
                    <div slot="reveal">
                      <span class="card-title grey-text text-darken-4">
                        ...
                        <p>
                          ...
                          <p>
                              Vue, Node, Socket, MongoDb, Express
                          </p>
                          <h5 class="flat-text-header hello">{{ $t("about.dev") }}</h5>
                          <p>
                              Author XXXX@gmail.com 2023
                          </p>
                        </p>
                    </div>
                </md-card>
...
export default {
  data () {
    return {
      ...
      user: UserService,
      board: Board,
      lenguajeName: 'English',
      lenguaje: Store.get('lenguaje', 'en'),
